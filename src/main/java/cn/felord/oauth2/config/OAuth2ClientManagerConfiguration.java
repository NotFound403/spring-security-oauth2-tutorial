...
import cn.felord.oauth2.wechat.WechatOAuth2RefreshTokenRequestEntityConverter;
...
public class OAuth2ClientManagerConfiguration {
    ...
    OAuth2AuthorizedClientManager oAuth2AuthorizedClientManager(ClientRegistrationRepository clientRegistrationRepository,
        ...
        defaultRefreshTokenTokenResponseClient.setRequestEntityConverter(new WechatOAuth2RefreshTokenRequestEntityConverter());
        ...
        // 兼容微信解析
        messageConverter.setAccessTokenResponseConverter(new WechatMapOAuth2AccessTokenResponseConverter());
